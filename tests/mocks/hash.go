...
func (mr *MockIHashCryptoMockRecorder) CheckPasswordHash(password, hash interface{}) *gomock.Call {
...
func (mr *MockIHashCryptoMockRecorder) GenerateHashPass(password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
